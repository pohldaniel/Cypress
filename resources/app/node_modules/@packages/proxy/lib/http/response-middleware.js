...
function reqMatchesPolicyBasedOnDomain(req, remoteState, documentDomainInjection) {
    if (remoteState.strategy === 'http') {
        return documentDomainInjection.urlsMatch(req.proxiedUrl, remoteState.props || '');
    }
...
const SetInjectionLevel = function () {
    ...
    const isReqMatchSuperDomainOrigin = reqMatchesPolicyBasedOnDomain(this.req, this.remoteStates.current(), network_1.DocumentDomainInjection.InjectionBehavior(this.config));
    span === null || span === void 0 ? void 0 : span.setAttributes({
    ...
    const getInjectionLevel = () => {
        ...
        const documentDomainInjection = network_1.DocumentDomainInjection.InjectionBehavior(this.config);
...
const MaybeInjectHtml = function () {
    ...
    this.incomingResStream.pipe((0, network_1.concatStream)(async (body) => {
        ...
        const injectedBody = await rewriter.html(decodedBody, {
            ...
            shouldInjectDocumentDomain: network_1.DocumentDomainInjection.InjectionBehavior(this.config).shouldInjectDocumentDomain(this.req.proxiedUrl),
