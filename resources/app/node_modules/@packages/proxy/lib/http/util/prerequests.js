...
class PreRequests {
    ...
    checkAndRemovePendingPreRequest(requestId) {
    ...
    addPending(browserPreRequest) {
        ...
        if (pendingRequest) {
            let cdpLagDuration;
            let proxyRequestCorrelationDuration = 0;
            ...
            const timings = {
                cdpRequestWillBeSentTimestamp: (_a = browserPreRequest.cdpRequestWillBeSentTimestamp) !== null && _a !== void 0 ? _a : 0,
                cdpRequestWillBeSentReceivedTimestamp: (_b = browserPreRequest.cdpRequestWillBeSentReceivedTimestamp) !== null && _b !== void 0 ? _b : 0,
            ...
            if (!pendingRequest.timedOut) {
                ...
                (_c = pendingRequest.callback) === null || _c === void 0 ? void 0 : _c.call(pendingRequest, {
                    browserPreRequest: {
                        ...browserPreRequest,
                        ...timings,
                    },
            ...
            (_d = this.protocolManager) === null || _d === void 0 ? void 0 : _d.responseStreamTimedOut({
        ...
        this.pendingPreRequests.push(key, {
            browserPreRequest,
            cdpRequestWillBeSentTimestamp: (_e = browserPreRequest.cdpRequestWillBeSentTimestamp) !== null && _e !== void 0 ? _e : 0,
            cdpRequestWillBeSentReceivedTimestamp: (_f = browserPreRequest.cdpRequestWillBeSentReceivedTimestamp) !== null && _f !== void 0 ? _f : 0,
        });
    }
