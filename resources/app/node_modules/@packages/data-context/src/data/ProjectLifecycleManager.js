...
class ProjectLifecycleManager {
    ...
    get configDebugData() {
        var _a;
        return (_a = this._configManager) === null || _a === void 0 ? void 0 : _a.debugData;
    }
    async getProjectId() {
        var _a;
        try {
    ...
    async setInitialActiveBrowser() {
        var _a, _b;
        const configDefaultBrowser = (_a = this.loadedFullConfig) === null || _a === void 0 ? void 0 : _a.defaultBrowser;
        ...
        if (this.ctx.coreData.cliBrowser) {
            ...
            const hasWelcomeBeenDismissed = Boolean((_b = preferences.majorVersionWelcomeDismissed) === null || _b === void 0 ? void 0 : _b[(0, types_1.GET_MAJOR_VERSION_FOR_CONTENT)()]);
