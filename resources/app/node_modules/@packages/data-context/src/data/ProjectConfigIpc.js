...
class ProjectConfigIpc extends events_1.default {
    constructor(nodePath, nodeVersion, projectRoot, configFilePath, configFile, onError, onWarning, onDebugData) {
        super();
    ...
    forkConfigProcess() {
        ...
        if ((0, util_1.hasTypeScriptInstalled)(this.projectRoot)) {
            ...
            if (isProjectUsingESModules) {
                ...
                if (this.nodeVersion && (semver_1.default.gte(this.nodeVersion, '22.7.0') || semver_1.default.satisfies(this.nodeVersion, '>= 20.19.0 < 21.0.0'))) {
                ...
                if (this.nodeVersion && (semver_1.default.gte(this.nodeVersion, '22.12.0') || semver_1.default.satisfies(this.nodeVersion, '>= 20.19.0 < 21.0.0'))) {
