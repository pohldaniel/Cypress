...
class ProjectConfigManager {
    ...
    loadConfig() {
        if (!this._loadConfigPromise) {
            ...
            this._eventsIpc = new ProjectConfigIpc_1.ProjectConfigIpc(this.options.ctx.coreData.app.nodePath, this.options.ctx.coreData.app.nodeVersion, this.options.projectRoot, this.configFilePath, this.options.configFile, (cypressError, title) => {
                this._state = 'errored';
                this.options.ctx.onError(cypressError, title);
            }, this.options.ctx.onWarning, (debugData) => {
                this._debugData = {
                    ...this._debugData,
                    ...debugData,
                };
