...
class FileDataSource {
    ...
    async getFilesByGlob(cwd, glob, globOptions = {}) {
        ...
        const nodeModulesInGlobPath = [].concat(glob).some((globPattern) => globPattern.includes('node_modules'));
        const ignoreNodeModules = !!((cwd.includes('node_modules') || nodeModulesInGlobPath));
        const ignoreGlob = ((_a = globOptions.ignore) !== null && _a !== void 0 ? _a : []).concat(ignoreNodeModules ? [] : '**/node_modules/**');
