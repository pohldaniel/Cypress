...
class DataContext {
    constructor(_config) {
        ...
        this._graphql = new sources_1.GraphQLDataSource();
        this._remoteRequest = new sources_1.RemoteRequestDataSource();
        this._file = new sources_1.FileDataSource(this);
        this._versions = new sources_1.VersionsDataSource(this);
        this._browser = new sources_1.BrowserDataSource(this);
        this._actions = new DataActions_1.DataActions(this);
        this._wizard = new sources_1.WizardDataSource(this);
        this._project = new sources_1.ProjectDataSource(this);
        this._relevantRuns = new sources_1.RelevantRunsDataSource(this);
        this._relevantRunSpecs = new sources_1.RelevantRunSpecsDataSource(this);
        this._cloud = new sources_1.CloudDataSource({
            fetch: (input, init) => this.util.fetch(input, init),
        ...
        this._env = new sources_1.EnvDataSource(this);
        this._emitter = new actions_1.DataEmitterActions(this);
        this._html = new sources_1.HtmlDataSource(this);
        this._error = new sources_1.ErrorDataSource(this);
        this._util = new sources_1.UtilDataSource(this);
        this._migration = new sources_1.MigrationDataSource(this);
