...
exports.CombinedAgent = exports.regenerateRequestHead = exports.isResponseStatusCode200 = exports.isRequestHttps = exports.createProxySock = exports.buildConnectReqHead = exports.clientCertificateStore = exports._resetBaseCaOptionsPromise = void 0;
...
let baseCaOptions;
const getCaOptionsPromise = () => {
    return (0, ca_1.getCaOptions)().then((options) => {
...
let baseCaOptionsPromise = getCaOptionsPromise();
// This is for testing purposes only
const _resetBaseCaOptionsPromise = () => {
    baseCaOptions = undefined;
    baseCaOptionsPromise = getCaOptionsPromise();
};
exports._resetBaseCaOptionsPromise = _resetBaseCaOptionsPromise;
const mergeCAOptions = (options, caOptions) => {
    if (!caOptions.ca) {
        return options;
    }
    if (!options.ca) {
    ...
    const caArray = lodash_1.default.castArray(options.ca).map((caOption) => caOption.toString());
    return {
        ...options,
...
class CombinedAgent {
    ...
    addRequest(req, options, port, localAddress) {
        ...
        if (typeof options.path === 'string' && /^http(s)?:\/\//.test(options.path)) {
            ...
            const portToSet = (_a = pathUrl.port) !== null && _a !== void 0 ? _a : options.port;
        ...
        const uri = options.uri = (_b = options.uri) !== null && _b !== void 0 ? _b : url_1.default.parse(options.href);
        ...
        return getFirstWorkingFamily(options, this.familyCache, (family) => {
            ...
            if (isHttps) {
                lodash_1.default.assign(options, exports.clientCertificateStore.getClientCertificateAgentOptionsForUrl(uri));
...
class HttpsAgent extends https_1.default.Agent {
    ...
    async addRequest(req, options) {
        ...
        if (!((_a = options === null || options === void 0 ? void 0 : options.uri) === null || _a === void 0 ? void 0 : _a.port) && ((_b = options === null || options === void 0 ? void 0 : options.uri) === null || _b === void 0 ? void 0 : _b.protocol) === 'https:') {
            options.uri = {
                ...options.uri,
                port: String(443),
            };
    ...
    createUpstreamProxyConnection(options, cb) {
        ...
        const proxy = url_1.default.parse(options.proxy);
        const port = ((_a = options.uri) === null || _a === void 0 ? void 0 : _a.port) || '443';
        const hostname = ((_b = options.uri) === null || _b === void 0 ? void 0 : _b.hostname) || 'localhost';
