...
exports.getSuperDomainOrigin = exports.urlMatchesOriginProtectionSpace = exports.urlMatchesPolicyBasedOnDomainProps = exports.policyFromConfig = exports.urlSameSiteMatch = exports.urlOriginsMatch = exports.urlMatchesPolicy = exports.urlMatchesPolicyProps = exports.domainPropsToHostname = exports.getDomainNameFromParsedHost = exports.getDomainNameFromUrl = exports.parseUrlIntoHostProtocolDomainTldPort = exports.parseDomain = exports.getSuperDomain = void 0;
...
function domainPropsToHostname({ domain, subdomain, tld }) {
    return lodash_1.default.compact([subdomain, domain, tld]).join('.');
}
exports.domainPropsToHostname = domainPropsToHostname;
/**
...
exports.urlMatchesPolicyProps = urlMatchesPolicyProps;
...
exports.urlMatchesPolicy = urlMatchesPolicy;
...
const urlMatchesPolicyBasedOnDomainProps = (frameUrl, topProps, opts) => {
    const policy = (opts === null || opts === void 0 ? void 0 : opts.injectDocumentDomain) ? 'same-super-domain-origin' : 'same-origin';
    return urlMatchesPolicyProps({
        policy,
        frameUrl,
        topProps,
