...
exports.Subscription = exports.StudioStatusPayload = void 0;
const nexus_1 = require("nexus");
const _1 = require(".");
const gql_Spec_1 = require("./gql-Spec");
const gql_RelevantRun_1 = require("./gql-RelevantRun");
exports.StudioStatusPayload = (0, nexus_1.objectType)({
    name: 'StudioStatusPayload',
    definition(t) {
        t.nonNull.field('status', {
            type: _1.StudioStatusTypeEnum,
        });
...
exports.Subscription = (0, nexus_1.subscriptionType)({
    definition(t) {
        ...
        t.nonNull.field('studioStatusChange', {
            type: exports.StudioStatusPayload,
            ...
            resolve: async (source, args, ctx) => {
                ...
                const canAccessStudioAI = studio.status === 'ENABLED' && ctx.coreData.activeBrowser && (await studio.canAccessStudioAI(ctx.coreData.activeBrowser)) || false;
                return {
