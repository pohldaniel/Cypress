...
exports.Query = (0, nexus_1.objectType)({
    ...
    definition(t) {
        ...
        t.field('cloudStudioRequested', {
            ...
            resolve: (source, args, ctx) => { var _a, _b; return (_b = (_a = ctx.coreData.studioLifecycleManager) === null || _a === void 0 ? void 0 : _a.cloudStudioRequested) !== null && _b !== void 0 ? _b : false; },
        });
