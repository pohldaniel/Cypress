...
const chromium_flags_1 = require("../util/chromium_flags");
...
const _getChromePreferences = (userDir) => {
    ...
    if (process.env.IGNORE_CHROME_PREFERENCES) {
        ...
        return bluebird_1.default.resolve(lodash_1.default.mapValues(CHROME_PREFERENCE_PATHS, () => ({})));
    }
...
const _setAutomation = async (client, automation, resetBrowserTargets, options) => {
    const cdpAutomation = await cdp_automation_1.CdpAutomation.create(client.send, client.on, client.off, resetBrowserTargets, automation, options.protocolManager, true, options.isTextTerminal);
...
module.exports = {
    ...
    _getArgs(browser, options, port) {
        const args = [].concat(chromium_flags_1.DEFAULT_CHROME_FLAGS);
    ...
    */
    ...
    async connectProtocolToBrowser(options) {
        ...
        await ((_a = options.protocolManager) === null || _a === void 0 ? void 0 : _a.connectToBrowser(browserCriClient.currentlyAttachedProtocolTarget));
    },
    async closeProtocolConnection() {
        const browserCriClient = this._getBrowserCriClient();
        if (browserCriClient === null || browserCriClient === void 0 ? void 0 : browserCriClient.currentlyAttachedProtocolTarget) {
    ...
    async attachListeners(url, pageCriClient, automation, options, browser) {
        ...
        await Promise.all([
            ...
            utils_1.default.initializeCDP(pageCriClient, automation),
        ]);
