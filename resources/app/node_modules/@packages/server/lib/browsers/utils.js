...
const initializeCDP = async (criClient, automation) => {
        ...
        if (data.name === 'cypressUtilityBinding') {
            ...
            switch (event.type) {
                case 'service-worker-registration':
                    ...
                    await ((_a = automation.onServiceWorkerClientSideRegistrationUpdated) === null || _a === void 0 ? void 0 : _a.call(automation, event));
                    break;
                case 'download':
                    ...
                    await ((_b = automation.onDownloadLinkClicked) === null || _b === void 0 ? void 0 : _b.call(automation, event.destination));
                    break;
                default:
