...
exports.closeExtraTargets = exports.open = exports.connectProtocolToBrowser = exports.connectToExisting = exports.connectToNewSpec = exports.clearInstanceState = exports.CDPFailedToStartFirefox = void 0;
...
async function open(browser, url, options, automation) {
    ...
    const [foxdriverPort, marionettePort, webDriverBiDiPort,] = await Promise.all([(0, get_port_1.default)(), (0, get_port_1.default)(), (0, get_port_1.default)()]);
    ...
    try {
        ...
        browserCriClient = await firefox_util_1.default.setup({ automation, url, foxdriverPort, webdriverClient, remotePort: cdpPort, onError: options.onError });
