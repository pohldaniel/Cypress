...
exports.closeExtraTargets = exports.open = exports.connectProtocolToBrowser = exports.connectToExisting = exports.clearInstanceState = exports.connectToNewSpec = void 0;
...
async function open(browser, url, options, automation) {
    ...
    let pw;
    try {
        pw = await Promise.resolve(`${pwModulePath}`).then(s => tslib_1.__importStar(require(s)));
    }
    catch (err) {
