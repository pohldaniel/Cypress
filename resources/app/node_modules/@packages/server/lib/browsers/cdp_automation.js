        ...
        this.onRequest = async (message, data) => {
            ...
            switch (message) {
                ...
                case 'key:press':
                    ...
                    return (0, key_press_1.cdpKeyPress)(data, this.sendDebuggerCommandFn, this.executionContexts, (await this.send('Page.getFrameTree')).frameTree);
                default:
