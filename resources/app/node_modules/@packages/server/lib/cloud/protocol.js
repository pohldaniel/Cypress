...
class ProtocolManager {
    ...
    async prepareProtocol(script, options) {
        ...
        try {
            ...
            if (script) {
                ...
                const { AppCaptureProtocol } = (0, require_script_1.requireScript)(script);
    ...
    async prepareAndSetupProtocol(script, options) {
    ...
    close() {
        var _a;
        (_a = this._db) === null || _a === void 0 ? void 0 : _a.close();
        this._db = undefined;
        if (this._dbPath) {
            fs_extra_1.default.unlink(this._dbPath).catch(() => { });
        }
        this._dbPath = undefined;
        if (this._archivePath) {
            fs_extra_1.default.unlink(this._archivePath).catch(() => { });
        }
