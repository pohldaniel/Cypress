...
class StreamActivityMonitor {
    ...
    markActivityInterval() {
        ...
        this.activityTimeout = setTimeout(() => {
            var _a;
            (_a = this.controller) === null || _a === void 0 ? void 0 : _a.abort(new stream_stalled_error_1.StreamStalledError(this.maxActivityDwellTime, DEFAULT_FS_READSTREAM_CHUNK_SIZE_BYTES));
