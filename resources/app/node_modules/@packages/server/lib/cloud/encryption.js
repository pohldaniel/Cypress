...
exports.decryptResponse = exports.encryptRequest = exports.verifySignatureFromFile = exports.verifySignature = void 0;
...
function verifySignatureFromFile(file, signature, publicKey) {
    const verify = crypto_1.default.createVerify('SHA256');
...
exports.verifySignatureFromFile = verifySignatureFromFile;
...
async function encryptRequest(params, options = {}) {
    const { publicKey = getPublicKey(), secretKey = crypto_1.default.createSecretKey(crypto_1.default.randomBytes(32)) } = options;
    ...
    return {
        ...
        jwe: {
            ...
            recipients: [
                {
                    encrypted_key: (0, base64url_1.default)(crypto_1.default.publicEncrypt(publicKey, secretKey.export())),
                },
            ],
