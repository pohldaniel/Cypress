...
exports.DEFAULT_ELECTRON_FLAGS = exports.DEFAULT_CHROME_FLAGS = exports.formatElectronFlags = exports.formatChromeFlags = void 0;
...
const formatChromeFlags = (flags) => flags.map((flag) => `--${flag}`);
exports.formatChromeFlags = formatChromeFlags;
// create an array of objects with name and value properties
// for each flag, splitting the flag on the first = character
const formatElectronFlags = (flags) => {
    return flags.map((flag) => {
        const [name, value] = flag.split('=');
        return value ? { name, value } : { name };
    });
};
exports.formatElectronFlags = formatElectronFlags;
exports.DEFAULT_CHROME_FLAGS = (0, exports.formatChromeFlags)(DEFAULT_FLAGS);
exports.DEFAULT_ELECTRON_FLAGS = (0, exports.formatElectronFlags)(exports.DEFAULT_CHROME_FLAGS);
