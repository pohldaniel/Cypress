...
class ServerBase {
    constructor(config) {
        ...
        this._documentDomainInjection = network_1.DocumentDomainInjection.InjectionBehavior(config);
        const remoteStatePorts = () => {
            var _a;
            return {
                server: this._port(),
                fileServer: (_a = this._fileServer) === null || _a === void 0 ? void 0 : _a.port(),
            };
        };
        this._remoteStates = new remote_states_1.RemoteStates(remoteStatePorts, this._documentDomainInjection);
    ...
    _onResolveUrl(urlStr, userAgent, automationRequest, options = { headers: {} }) {
        ...
        return this._urlResolver = (p = new bluebird_1.default((resolve, reject, onCancel) => {
            ...
            if (!fullyQualifiedRe.test(urlStr)) {
                ...
                urlFile = (state === null || state === void 0 ? void 0 : state.fileServer) ? url_1.default.resolve(state.fileServer, urlStr) : url_1.default.resolve('', urlStr);
                urlStr = (state === null || state === void 0 ? void 0 : state.origin) ? url_1.default.resolve(state.origin, urlStr) : url_1.default.resolve('', urlStr);
            }
