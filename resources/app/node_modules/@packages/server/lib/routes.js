...
const createCommonRoutes = ({ config, networkProxy, testingType, getSpec, remoteStates, nodeProxy, onError, }) => {
    ...
    if (process.env.CYPRESS_INTERNAL_E2E_TESTING_SELF_PARENT_PROJECT) {
        ...
        const studioRouter = (0, express_1.Router)();
        router.use('/', studioRouter);
        (_a = (0, data_context_1.getCtx)().coreData.studioLifecycleManager) === null || _a === void 0 ? void 0 : _a.registerStudioReadyListener((studio) => {
    ...
    router.get(`/${config.namespace}/spec-bridge-iframes`, async (req, res) => {
        ...
        await files_1.default.handleCrossOriginIframe(req, res, config);
    });
    ...
    router.get(`/${namespace}/iframes/*`, async (req, res) => {
        if (testingType === 'e2e') {
            await iframes_1.iframesController.e2e({ config, getSpec, remoteStates }, req, res);
        }
