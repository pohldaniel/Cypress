        ...
        this.getIos().forEach((io) => {
            io === null || io === void 0 ? void 0 : io.on('connection', (socket) => {
                ...
                socket.on('automation:client:connected', () => {
                    ...
                    socket.on('automation:push:request', async (message, data, cb) => {
                ...
                const setCrossOriginCookie = ({ cookie, url, sameSiteContext }) => {
                    ...
                    cookies_1.cookieJar.setCookie((0, cookies_1.automationCookieToToughCookie)(cookie, hostname), url, sameSiteContext);
                };
                ...
                (_b = (0, data_context_1.getCtx)().coreData.studioLifecycleManager) === null || _b === void 0 ? void 0 : _b.registerStudioReadyListener((studio) => {
                ...
                socket.on('studio:protocol:enabled', async (cb) => {
                    ...
                    try {
                        const ctx = await (0, data_context_1.getCtx)();
                        const isStudioReady = (_a = ctx.coreData.studioLifecycleManager) === null || _a === void 0 ? void 0 : _a.isStudioReady();
                        if (!isStudioReady) {
                            return cb({ studioProtocolEnabled: false });
                        }
                        const studio = await ((_b = ctx.coreData.studioLifecycleManager) === null || _b === void 0 ? void 0 : _b.getStudio());
                        cb({ studioProtocolEnabled: studio === null || studio === void 0 ? void 0 : studio.isProtocolEnabled });
                    }
                    catch (error) {
                        cb({ error: errors.cloneErr(error) });
                    }
