    ...
    const ctx = new data_context_1.DataContext({
        ...
        projectApi: {
            ...
            insertProjectToCache(projectRoot) {
                return cache_1.cache.insertProject(projectRoot);
            },
            async getProjectRootsFromCache() {
                return cache_1.cache.getProjectRoots().then((roots) => {
            ...
            clearLatestProjectsCache() {
                return cache_1.cache.removeLatestProjects();
            },
            getProjectPreferencesFromCache() {
                return cache_1.cache.getProjectPreferences();
            },
            clearProjectPreferences(projectTitle) {
                return cache_1.cache.removeProjectPreferences(projectTitle);
            },
            clearAllProjectPreferences() {
                return cache_1.cache.removeAllProjectPreferences();
            },
            insertProjectPreferencesToCache(projectTitle, preferences) {
                return cache_1.cache.insertProjectPreferences(projectTitle, preferences);
            },
            removeProjectFromCache(path) {
                return cache_1.cache.removeProject(path);
            },
            closeActiveProject() {
            ...
            resetBrowserTabsForNextSpec(shouldKeepTabOpen) {
                return open_project_1.openProject.resetBrowserTabsForNextSpec(shouldKeepTabOpen);
            },
            resetServer() {
                var _a;
