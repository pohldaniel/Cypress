...
function updateWithPluginValues(cfg, modifiedConfig, testingType) {
    ...
    const diffsClone = (_c = lodash_1.default.cloneDeep(diffs)) !== null && _c !== void 0 ? _c : {};
    // merge cfg into overrides
    const merged = (_d = lodash_1.default.defaultsDeep(diffs, cfg)) !== null && _d !== void 0 ? _d : {};
    for (const [key, value] of Object.entries(diffsClone)) {
        if (Array.isArray(value)) {
            merged[key] = lodash_1.default.cloneDeep(value);
        }
    }
