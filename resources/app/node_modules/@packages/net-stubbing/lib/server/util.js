...
exports.getBodyEncoding = exports.mergeWithPreservedBuffers = exports.mergeDeletedHeaders = exports.getBodyStream = exports.sendStaticResponse = exports.setResponseFromFixture = exports.setDefaultHeaders = exports.getAllStringMatcherFields = exports.emit = exports.parseContentType = void 0;
...
const isValidJSON = function (text) {
    ...
    try {
        ...
        return lodash_1.default.isObject(o);
    }
    catch (error) {
        false;
    }
...
function parseContentType(response) {
    if (isValidJSON(response)) {
        return mime_1.default.getType('json');
    }
    if (response && htmlLikeRe.test(response)) {
        return mime_1.default.getType('html');
    }
    return mime_1.default.getType('text');
}
...
async function setResponseFromFixture(getFixtureFn, staticResponse) {
    ...
    if (!headers || !(0, util_1.caseInsensitiveGet)(headers, 'content-type')) {
        ...
        const mimeType = mime_1.default.getType(fixture.filePath) || parseContentType(data);
